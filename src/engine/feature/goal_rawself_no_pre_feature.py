...
class GOAL_RAWSELF_NO_PRE_FEATURE(ABSTRACT_FEATURE):
	def __init__(self):
		self.name = 'GOAL_RAWSELF_NO_PRE_FEATURE'
		self.params = {}
...
#			away_pre_num.append(pre_serry_feature[away_team_id]['away_num'])
			home_res = [[home_match_score,home_current_serryscore],[home_match_num,home_current_serrynum]]
			away_res = [[away_match_score,away_current_serryscore],[away_match_num,away_current_serrynum]]
			res_home = {}
			res_home['date'] = date
