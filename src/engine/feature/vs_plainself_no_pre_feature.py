...
class VS_PLAINSELF_NO_PRE_FEATURE(ABSTRACT_FEATURE):
	def __init__(self):
		self.name = 'VS_PLAINSELF_NO_PRE_FEATURE'
		self.params = {}
...
#			away_pre_feature.append(pre_serry_feature[away_team_id]['away_mean'])
			home_res = [home_match_feature,home_current_serryfeature] 
			away_res = [away_match_feature,away_current_serryfeature]
			res_home = {}
			res_home['date'] = date
