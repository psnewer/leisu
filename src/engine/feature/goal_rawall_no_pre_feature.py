...
class GOAL_RAWALL_NO_PRE_FEATURE(ABSTRACT_FEATURE):
	def __init__(self):
		self.name = 'GOAL_RAWALL_NO_PRE_FEATURE'
		self.params = {}
...
#			away_pre_to_num.append(pre_serry_feature[away_team_id]['away_num'])
			home_res = [[home_match_score,home_current_self_serryscore,home_current_to_serryscore],[home_match_num,home_current_self_serrynum,home_current_to_serrynum]]
			away_res = [[away_match_score,away_current_self_serryscore,away_current_to_serryscore],[away_match_num,away_current_self_serrynum,away_current_to_serrynum]]
			res_home = {}
			res_home['date'] = date
