...
class VS_PLAINSELF_NO_PRE_EXTRACTOR(ABSTRACT_EXTRACTOR):
	def __init__(self):
		self.name = 'VS_PLAINSELF_NO_PRE_EXTRACTOR'
		self.params = {}
...
#				away_pre_feature.append(pre_serry_feature[away_team_id]['away_mean'])
				home_res.append([home_match_feature,home_current_serryfeature])
				away_res.append([away_match_feature,away_current_serryfeature])
