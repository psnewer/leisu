...
class VS_PLAINALL_EXTRACTOR(ABSTRACT_EXTRACTOR):
	def __init__(self):
		self.name = 'VS_PLAINALL_EXTRACTOR'
		self.params = {}
...
#				continue
			...
			for ind,row in df.iterrows():
				...
				home_current_self_serryfeature = []
				home_current_to_serryfeature = []
				for i in range(0,self.params['levels']):
					home_current_self_serryfeature.append(serry_current_serryfeature[home_team_id][date]['level']['self'][i]['score'])
					home_current_to_serryfeature.append(serry_current_serryfeature[home_team_id][date]['level']['to'][i]['score'])
				home_current_self_serryfeature.append(serry_current_serryfeature[home_team_id][date]['home_mean'])
				home_current_to_serryfeature.append(serry_current_serryfeature[home_team_id][date]['home_mean'])
				home_current_self_serryfeature.append(serry_current_serryfeature[home_team_id][date]['away_mean'])
				home_current_to_serryfeature.append(serry_current_serryfeature[home_team_id][date]['away_mean'])
				away_current_self_serryfeature = []
				away_current_to_serryfeature = []
				for i in range(0,self.params['levels']):
					away_current_self_serryfeature.append(serry_current_serryfeature[away_team_id][date]['level']['self'][i]['score'])
					away_current_to_serryfeature.append(serry_current_serryfeature[away_team_id][date]['level']['to'][i]['score'])
				away_current_self_serryfeature.append(serry_current_serryfeature[away_team_id][date]['home_mean'])
				away_current_to_serryfeature.append(serry_current_serryfeature[away_team_id][date]['home_mean'])
				away_current_self_serryfeature.append(serry_current_serryfeature[away_team_id][date]['away_mean'])
				away_current_to_serryfeature.append(serry_current_serryfeature[away_team_id][date]['away_mean'])
				home_pre_self_feature = []
				home_pre_to_feature = []
				for i in range(0,self.params['levels']):
					home_pre_self_feature.append(pre_serry_feature[home_team_id]['level']['self'][i]['score'])
					home_pre_to_feature.append(pre_serry_feature[home_team_id]['level']['to'][i]['score'])
				home_pre_self_feature.append(pre_serry_feature[home_team_id]['home_mean'])
				home_pre_to_feature.append(pre_serry_feature[home_team_id]['home_mean'])
				home_pre_self_feature.append(pre_serry_feature[home_team_id]['away_mean'])
				home_pre_to_feature.append(pre_serry_feature[home_team_id]['away_mean'])
				away_pre_self_feature = []
				away_pre_to_feature = []
				for i in range(0,self.params['levels']):
					away_pre_self_feature.append(pre_serry_feature[away_team_id]['level']['self'][i]['score'])
					away_pre_to_feature.append(pre_serry_feature[away_team_id]['level']['to'][i]['score'])
				away_pre_self_feature.append(pre_serry_feature[away_team_id]['home_mean'])
				away_pre_to_feature.append(pre_serry_feature[away_team_id]['home_mean'])
				away_pre_self_feature.append(pre_serry_feature[away_team_id]['away_mean'])
				away_pre_to_feature.append(pre_serry_feature[away_team_id]['away_mean'])
				home_res.append([home_match_feature,home_current_self_serryfeature,home_current_to_serryfeature,home_pre_self_feature,home_pre_to_feature])
				away_res.append([away_match_feature,away_current_self_serryfeature,away_current_to_serryfeature,away_pre_self_feature,away_pre_to_feature])
