...
class VS_WIN_EXTRACTOR(ABSTRACT_EXTRACTOR):
	def __init__(self):
		self.name = 'VS_WIN'
		self.params = {}
	...
	def analyze_procedure(self, procedure, team, is_home):
		...
		if no_goals:
			...
			raw = 0
		elif has_goal and draw_at_some_point and (not team_won or team_draw):
			raw = -1
		else:
			raw = 1
		...
		if no_goals:
			...
			taw = -1
		elif has_goal and draw_at_some_point and (team_won or team_draw):
			taw = -1
