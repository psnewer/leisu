...
class VS_RAWRAW_EXTRACTOR(ABSTRACT_EXTRACTOR):
	...
	def generate_rows(self, df):
		...
		for idx, row in df.iterrows():
			...
			home_raw,home_taw,home_raw_win,home_taw_win,home_raw_draw,home_taw_draw,home_rawraw = self.analyze_procedure(procedure, score, is_home=True)
			away_raw,away_taw,away_raw_win,away_taw_win,away_raw_draw,away_taw_draw,away_rawraw = self.analyze_procedure(procedure, score, is_home=False)
